...
const TechSkillCard = memo(({ icon, name, index = 0 }) => (
  ...
  >
    ...
    <span className="text-[10px] sm:text-[11px] text-secondary text-center leading-tight capitalize transition-colors duration-300 group-hover:text-white line-clamp-2">
      {name}
    </span>
  </motion.div>
));
